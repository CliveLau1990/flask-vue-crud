...
if(platform.system()=="Windows"):
    if "64bit" in platform.architecture():
        windll.LoadLibrary( "./USB2XXX/libs/msvc_x64/libusb-1.0.dll" )
        USB2XXXLib = windll.LoadLibrary( "./USB2XXX/libs/msvc_x64/USB2XXX.dll" )
    else:
        windll.LoadLibrary( "./USB2XXX/libs/msvc_x86/libusb-1.0.dll" )
        USB2XXXLib = windll.LoadLibrary( "./USB2XXX/libs/msvc_x86/USB2XXX.dll" )
elif(platform.system()=="Darwin"):
    cdll.LoadLibrary( "./USB2XXX/libs/mac_os/libusb-1.0.dylib" )
    USB2XXXLib = cdll.LoadLibrary( "./USB2XXX/libs/mac_os/libUSB2XXX.dylib" )
elif(platform.system()=="Linux"):
    if 'arm' in platform.machine():
        cdll.LoadLibrary( "./USB2XXX/libs/linux/ARMv7/libusb-1.0.so" )
        USB2XXXLib = cdll.LoadLibrary( "./USB2XXX/libs/linux/ARMv7/libUSB2XXX.so" )
    else:
        if "64bit" in platform.architecture():
            cdll.LoadLibrary( "./USB2XXX/libs/Linux_x64/libusb-1.0.so" )
            USB2XXXLib = cdll.LoadLibrary( "./USB2XXX/libs/Linux_x64/libUSB2XXX.so" )
        else:
            cdll.LoadLibrary( "./USB2XXX/libs/Linux_x64/libusb-1.0.so" )
            USB2XXXLib = cdll.LoadLibrary( "./USB2XXX/libs/Linux_x86/libUSB2XXX.so" )
else:
